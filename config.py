...
EXTERNAL_DATA_DIR = WORKSPACE_DIR / "最终文件" / "大创"
DEFAULT_DATA_DIR = PROJECT_DATA_DIR if PROJECT_DATA_DIR.exists() else EXTERNAL_DATA_DIR
DEFAULT_PURE_FILE = DEFAULT_DATA_DIR / "data-纯品.csv"
DEFAULT_PATIENT_FILE = DEFAULT_DATA_DIR / "data-原始_基础展示120.csv"
DEFAULT_MEAN_FILE = DEFAULT_DATA_DIR / "data-均值.csv"
DEFAULT_NNLS_RESULT = DEFAULT_DATA_DIR / "混合物分解概率结果.csv"
DEFAULT_VALIDATION_FILE = (
    DEFAULT_DATA_DIR / "送检目录_脱敏.xlsx"
    if (DEFAULT_DATA_DIR / "送检目录_脱敏.xlsx").exists()
    else DEFAULT_DATA_DIR / "送检目录(2).xlsx"
)
